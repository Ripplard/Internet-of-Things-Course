...
// 偵測id為sld_lightness輸入是否改變，如改變則回調lightnessDebounceFn副程式(綁定input事件)
$(document).on("input", "input[type=range]", debouncefn);

//$(document).on("input", "#sld_lightness", lightnessDebounceFn);
//$(document).on("input", "#sld_servo", servoAngleDebounceFn);
